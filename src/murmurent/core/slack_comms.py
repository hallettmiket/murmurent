"""
Purpose: Orchestration layer for murmurent's Slack communication fabric.
Author: Mike Hallett (with Claude Code)
Date: 2026-07-03

Wires the existing engines into the murmurent lifecycle so Slack is the primary
comms channel:
...
log = logging.getLogger("murmurent.slack_comms")
