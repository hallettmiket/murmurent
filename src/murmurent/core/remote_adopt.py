...
Why a single batched script: each SSH handshake on biodatsci costs
...
def build_remote_adopt_script(
    *,
    ...
    lines = [
        ...
        # script (resolved at script-runtime via $WIG). On biodatsci
        # this expands to /home/UWO/mhallet/repos/wigamig/scripts/...
