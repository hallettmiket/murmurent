"""
Purpose: Public lab/core/admin/pi join-request queue for a murmurent
...
class JoinRequest:
    ...
    # Provenance for requests ingested from the murmurent_public hub:
...
def file_request(
    *,
    ...
    from the murmurent_public hub, whose public form collects no email — the
