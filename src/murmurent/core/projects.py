...
class ProjectSummary:
    ...
    # 2026-05-14: lab the project belongs to (e.g. "hallett", "core_lead").
...
def render_registry_entry(
    ...
    *,
    ...
    (e.g. ``"lab-server"``) when the working tree lives on a remote host.
...
def archive_project(
    ...
    *,
    ...
    # user may want to clean up by hand — murmurent never touches these.
