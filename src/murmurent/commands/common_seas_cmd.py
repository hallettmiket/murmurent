"""
Purpose: ``murmurent common-sea`` — terminal-first CRUD for the centre's
         common-SEAs catalog.
...
Examples:
    ...
    murmurent common-sea list
    murmurent common-sea list --kind skill --tag qc
    murmurent common-sea show qc_drift_routine

    # Submit (defaults owner_lab to your local lab).
    murmurent common-sea submit \\
    ...
    murmurent common-sea archive qc_drift_routine
