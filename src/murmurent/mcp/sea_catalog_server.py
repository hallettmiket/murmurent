...
``murmurent install --hooks`` in a future phase)::

    python -m murmurent.mcp.sea_catalog_server
"""
...
# ---------------------------------------------------------------------------
# stdio MCP shim — wire-up lands when murmurent install --hooks supports it
# ---------------------------------------------------------------------------
