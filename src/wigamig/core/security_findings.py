...
class Finding:
    ...
    host: str                            # "biodatsci" | "local"
    path: str                            # absolute on the target host
    current_state: str                   # human summary, e.g. "0664 mhallet:ssmd-u"
    expected_state: str                  # "0444 mhallet:ssmd-u"
    ...
    owner_handle: str | None = None      # "@mhallet" when attributable to a member
    project: str | None = None           # wigamig project name when attributable
