...
wigamig centre, held ONLY by the mayor. Distinct from a member's per-machine key
...
The centre publishes TWO public keys in the ``wigamig_public`` installations
...
# ---------------------------------------------------------------------------
# Self-signed installation entry (what gets published to wigamig_public)
# ---------------------------------------------------------------------------
