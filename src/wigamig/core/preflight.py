...
# would defeat that protection by re-routing writes through wigamig.
    ...
    if blocked:
        probes.append(Probe(
            ...
            detail=(
                ...
                "directory and let wigamig manage raw/ + refined/ underneath."
            ),
            required=True,
        ))
        return probes
...
def probe_obsidian_vault(vault_path: str | None) -> Probe:
    ...
    return Probe(
        ...
        detail=(
            ...
            "vault) — wigamig will not create vault folders on your behalf."
        ),
        required=False,
    )
