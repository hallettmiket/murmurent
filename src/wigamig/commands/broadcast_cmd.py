"""
Purpose: ``wigamig broadcast`` — send a tier-tailored Slack message
         to the centre.
...
Examples:
    ...
    wigamig broadcast --to leaders --message "Quarterly cores review Friday 2pm"

    # Actually send.
    wigamig broadcast --to leaders --message "Quarterly cores review Friday 2pm" --apply

    # List recent broadcasts (any month).
    wigamig broadcast recent --limit 5
"""
