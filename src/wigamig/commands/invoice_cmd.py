"""
Purpose: ``wigamig core-invoice`` — month-end per-lab invoice generator.
...
Examples:
    ...
    wigamig core-invoice --core biocore --month 2026-05 --apply

    # Finalised invoices only (exclude unconfirmed actual_charge rows).
    wigamig core-invoice --core biocore --month 2026-05 --apply --finalised
"""
