...
class GitProvider(BaseModel):
    ...
    # github: org name; gitea: base URL like https://biodatsci/gitea;
...
class LabSettings(BaseModel):
    ...
    # ``biodatsci.schulich.uwo.ca:/data/lab_vm/wigamig``. When unset the
...
class DashboardResponse(BaseModel):
    ...
    # the user can see at a glance whether biodatsci has been
