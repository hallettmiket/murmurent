...
def _quickstart_readme_content(project: str) -> str:
    ...
    current wigamig install. The opening section deliberately leads with
...
*Generated by wigamig. Regenerates each time you launch this project — your edits here will be overwritten.*
"""
...
def _write_quickstart_help(project: str) -> WorkspaceFolder:
    ...
    see the cheatsheet that matches the wigamig version that just opened
