...
# a synthesized projection over NFSv4 ACLs (OneFS-via-NFSv3, the
# biodatsci case). Used to decide whether to skip raw/refined POSIX
...
# Detect whether POSIX bits are meaningful on $LAB_VM_ROOT. On OneFS
# served over NFSv3 (biodatsci's /data), they aren't — see
