    ...
    <div onClick={() => onClose(false)} style={{
      ...
      <form onSubmit={submit} onClick={(e) => e.stopPropagation()} style={{
        ...
        <input style={inp} value={form.members_text} onChange={set("members_text")}
               placeholder="@mhallet @alice" required />
    ...
    <div onClick={onClose} style={{
      ...
      <form onSubmit={submit} onClick={(e) => e.stopPropagation()} style={{
        ...
        <input style={inp} value={form.partner_groups}
               ...
               placeholder="e.g. vdumeaux, imaging_core" required />
        ...
        <input style={inp} value={form.partner_pis}
               ...
               placeholder="e.g. @vdumeaux, @dlee" required />
...
/* ───────── Hosts modal (R4: register + probe install targets) ─────────
   Lets the user register a remote SSH host (biodatsci is the canonical
...
function MasterFoldersPanel({ labBase }) {
  ...
  const [busy, setBusy] = useState(false);
  const [err, setErr] = useState(null);
  // Lockout cooldown: biodatsci locks the account for 30 minutes after
    ...
    <div style={{marginTop:12, padding:"10px 12px",
      ...
      {onCooldown && (
        <div style={{
          ...
          <strong>Auth failure detected.</strong> biodatsci locks the account for
          ...
          (2) verify <code>ssh biodatsci.schulich.uwo.ca</code> works in a
          terminal; (3) install your key with <code>ssh-copy-id -i ~/.ssh/laptop.pub biodatsci.schulich.uwo.ca</code> if it isn't already authorized.
...
function GitProvidersEditor({ value, onChange }) {
  ...
  const HINTS = {
    ...
    "gitea":      "target = base URL (e.g. https://biodatsci/gitea)",
      ...
      <form onSubmit={submit} onClick={(e) => e.stopPropagation()} style={{
        ...
        <div style={sectionStyle}>
          ...
          {storageRow({
            ...
            hostPh: "biodatsci.schulich.uwo.ca", pathPh: dataRoot,
          })}
