...
## Current operators
- @vanessa.dumeaux (since 2026-04-01)

## Audit log
- 2026-04-01: assigned @vanessa.dumeaux (PI: @mike.hallett, signed)
- 2026-01-15: revoked @prev_admin (handoff complete)
- 2026-01-01: assigned @prev_admin (PI: @mike.hallett, signed)
```
...
squad: dcis_imaging
scope: project
lead: '@vanessa.dumeaux'
members: ['@mike.hallett', '@lauren.smith']
pi_present: true
status: active
parent: null
---
...
## Sub-squads
- exp/3_titration (lead: @lauren.smith)

## Audit log
- 2026-04-01: formed (PI: @mike.hallett, lead: @vanessa.dumeaux)
- 2026-04-15: invited @lauren.smith
```
...
- @lauren.smith: dissents on the molecular interpretation; sees this as a phenocopy

## Approval log
- @vanessa.dumeaux: approved 2026-05-12
- @lauren.smith: approved with dissent 2026-05-12
- @mike.hallett (PI): approved 2026-05-13
```
...
```json
{"ts": "2026-05-06T10:14:22Z", "member": "@mike.hallett", "project": "dcis_imaging",
...
```
<system-reminder>
Active project: dcis_imaging (lead: @vanessa.dumeaux)
Your role: member
...
- outgoing #41: clinical metadata join (assigned to @lauren.smith, in progress)
</system-reminder>
```
