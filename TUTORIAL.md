...
```bash
MURMURENT_USER=mhallet murmurent sea examine 3
...
# MURMURENT_USER=mhallet   -> ask the adversary agent to challenge the methodology.
...
MURMURENT_USER=mhallet murmurent sea conclude 3 --statement /tmp/sea3.md
```
...
MURMURENT_USER=mhallet murmurent push dcis_sc_tutorial --finalize \
